...
export default class Body {
    ...
    updateBounds() {
        ...
        if (asx !== this._sx || asy !== this._sy) {
            ...
            this.height = Math.ceil(
                this.sprite.height - this.sprite.width * 0.5
            );
    ...
    update(time, delta) {
        ...
        if (this.moves) {
            ...
            if (
                ...
                !world.bounds.intersects(this.sprite.isoBounds)
            ) {
                this.sprite.kill();
            }
        }
    ...
    checkWorldBounds() {
        ...
        if (
            ...
            world.checkCollision.down
        ) {
            this.position.z = world.bounds.z;
            this.velocity.z *= -this.bounce.z;
            this.blocked.down = true;
        } else if (
            this.top > world.bounds.top &&
            world.checkCollision.up
        ) {
    ...
    reset(x, y, z) {
        ...
        this.position.x =
            x +
            (this.widthX * -this.sprite.anchor.x +
                this.widthX * 0.5) +
            this.offset.x;
        this.position.y =
            y +
        ...
        this.position.z =
            z -
            Math.abs(this.sprite.height) *
                (1 - this.sprite.anchor.y) +
            Math.abs(this.sprite.width * 0.5) +
            this.offset.z;
    ...
    getCorners() {
        ...
        this._corners[3].setTo(
            this.x,
            this.y + this.widthY,
            this.z + this.height
        );
        this._corners[4].setTo(this.x + this.widthX, this.y, this.z);
        this._corners[5].setTo(
            this.x + this.widthX,
            this.y,
            this.z + this.height
        );
        this._corners[6].setTo(
            this.x + this.widthX,
            this.y + this.widthY,
            this.z
        );
