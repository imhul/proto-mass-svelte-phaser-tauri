...
export default class World {
    ...
    separateX(body1, body2, overlapOnly) {
        ...
        if (this._overlap !== 0) {
            ...
            if (!body1.immovable && !body2.immovable) {
                ...
                this._average =
                    (this._newVelocity1 + this._newVelocity2) * 0.5;
                this._newVelocity1 -= this._average;
                this._newVelocity2 -= this._average;

                body1.velocity.x =
                    this._average +
                    this._newVelocity1 * body1.bounce.x;
                body2.velocity.x =
                    this._average +
                    this._newVelocity2 * body2.bounce.x;
            } else if (!body1.immovable) {
                body1.x = body1.x - this._overlap;
                body1.velocity.x =
                    this._velocity2 -
                    this._velocity1 * body1.bounce.x;
            } else if (!body2.immovable) {
                body2.x += this._overlap;
                body2.velocity.x =
                    this._velocity1 -
                    this._velocity2 * body2.bounce.x;
            }
    ...
    separateY(body1, body2, overlapOnly) {
        ...
        if (this._overlap !== 0) {
            ...
            if (!body1.immovable && !body2.immovable) {
                ...
                body1.velocity.y =
                    this._average +
                    this._newVelocity1 * body1.bounce.y;
                body2.velocity.y =
                    this._average +
                    this._newVelocity2 * body2.bounce.y;
            } else if (!body1.immovable) {
                body1.y = body1.y - this._overlap;
                body1.velocity.y =
                    this._velocity2 -
                    this._velocity1 * body1.bounce.y;
            } else if (!body2.immovable) {
                body2.y += this._overlap;
                body2.velocity.y =
                    this._velocity1 -
                    this._velocity2 * body2.bounce.y;
            }
    ...
    separateZ(body1, body2, overlapOnly) {
        ...
        if (this._overlap !== 0) {
            ...
            if (!body1.immovable && !body2.immovable) {
                ...
                body1.velocity.z =
                    this._average +
                    this._newVelocity1 * body1.bounce.z;
                body2.velocity.z =
                    this._average +
                    this._newVelocity2 * body2.bounce.z;
            } else if (!body1.immovable) {
                body1.z = body1.z - this._overlap;
                body1.velocity.z =
                    this._velocity2 -
                    this._velocity1 * body1.bounce.z;
                ...
                body2.velocity.z =
                    this._velocity1 -
                    this._velocity2 * body2.bounce.z;
    ...
    collideGroupVsGroup(
        ...
        if (
            group1.children.size === 0 ||
            group2.children.size === 0
        ) {
            return;
        }
